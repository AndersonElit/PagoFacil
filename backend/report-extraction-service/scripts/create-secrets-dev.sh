...
SECRET_NAME="pagofacil/dev/report-extraction-service"
...
if aws --endpoint-url="$ENDPOINT" secretsmanager describe-secret \
    ...
    aws --endpoint-url="$ENDPOINT" secretsmanager put-secret-value \
        ...
        --secret-string '{"AWS_ENDPOINT_URL": "http://localhost:4566", "AWS_ACCESS_KEY_ID": "test", "AWS_SECRET_ACCESS_KEY": "test", "AWS_REGION": "us-east-1", "REPORT_BUCKET": "reports", "KAFKA_BOOTSTRAP_SERVERS": "localhost:9092", "JDBC_URL": "jdbc:postgresql://localhost:5432/pagofacil_readmodel", "JDBC_TABLE": "ventas", "JDBC_USER": "app", "JDBC_PASSWORD": "app"}' \
        --region "$REGION"
