...
lazy val entryPoints = project
  ...
  .settings(
    ...
    Compile / run / mainClass := Some("com.example.reportextractionservice.infrastructure.entrypoints.BatchMain"),
    assembly / mainClass := Some("com.example.reportextractionservice.infrastructure.entrypoints.BatchMain"),
